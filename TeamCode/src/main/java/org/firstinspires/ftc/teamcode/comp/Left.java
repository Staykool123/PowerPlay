...
public class Left extends LinearOpMode
{
    ...
    public void runOpMode()
    {
        ...
        Trajectory dropSeq = drive.trajectoryBuilder(new Pose2d(-22,.5,270))
        ...
        Trajectory backSeq = drive.trajectoryBuilder(new Pose2d(-24, -40, 270))
                .lineTo((new Vector2d(-50, -42)))
                .build();

        Trajectory frontSeq = drive.trajectoryBuilder(new Pose2d(-24, -40, 270))
                .lineTo((new Vector2d(-2, -42)))
                .build();
